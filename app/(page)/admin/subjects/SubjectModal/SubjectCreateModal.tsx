...
export default function SubjectCreateModal({ onClose }: { onClose: () => void }) {
    const { register, handleSubmit, formState: { errors }, reset } = useForm<ICreateSubject>({ mode: "onTouched" });
    const mutation = useCreateSubject(onClose);
